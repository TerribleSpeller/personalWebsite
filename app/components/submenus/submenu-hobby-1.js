  ...
  return (
    <>
      <div className="d-flex flex-column flex-md-row">
        <div className="tab-submenu cool-background-5 col-md-3">
          <button className={`tablinks-submenu  ${activeTab === 'py' ? 'active' : ''} cool-background-5`} onClick={() => openSubTab('py')}><span className="highLight">Python</span></button>
          <button className={`tablinks-submenu rounded-4 ${activeTab === 'EJS' ? 'active' : ''} cool-background-5`} onClick={() => openSubTab('EJS')}><span className="highLight">EJS/JavaScript</span></button>
          <button className={`tablinks-submenu rounded-4 ${activeTab === 'C++' ? 'active' : ''} cool-background-5`} onClick={() => openSubTab('C++')}><span className="highLight">C++</span></button>
          <button className={`tablinks-submenu rounded-4 ${activeTab === 'Kotlin' ? 'active' : ''} cool-background-5`} onClick={() => openSubTab('Kotlin')}><span className="highLight">Kotlin</span></button>
          <button className={`tablinks-submenu rounded-4 ${activeTab === 'PHP' ? 'active' : ''} cool-background-5`} onClick={() => openSubTab('PHP')}><span className="highLight">PHP</span></button>
        </div>
        <div className="flex-grow-1 flex-fill col-md-11 ">
          <div id="py" className={`tabcontent-submenu ${activeTab === 'py' ? 'show' : ''} bg-light cool-background-4`}>
            <h3>Python</h3>
          ...
          <div id="EJS" className={`tabcontent-submenu ${activeTab === 'EJS' ? 'show' : ''} bg-light cool-background-4`}>
          ...
          <div id="C++" className={`tabcontent-submenu ${activeTab === 'C++' ? 'show' : ''} bg-light cool-background-4`}>
            <h3>C++</h3>
          ...
          <div id="Kotlin" className={`tabcontent-submenu ${activeTab === 'Kotlin' ? 'show' : ''} bg-light cool-background-4`}>
            <h3>Kotlin</h3>
            <p>With IoT becoming significantly more important, mobile applications are a growing avenue that needs to be taken note of and exploited. So far, I have {(currentYear - 2024) === 1 ? `${currentYear - 2024} year` : `${currentYear - 2024} years`} of experience with them, mainly with the utilization of Kotlin and Android Studio. Kotlin was the first language I learned that had the capbilities to be deployed on Android, and with it I learned how to deploy apps that can interact with the rest of the IoT network. Going so far to have one semester's final project to involve using one such application! </p>
          </div>

          <div id="PHP" className={`tabcontent-submenu ${activeTab === 'PHP' ? 'show' : ''} bg-light cool-background-4`}>
            <h3>PHP</h3>
            <p>PHP is a general purpose language, one that I have {(currentYear - 2024) === 1 ? `${currentYear - 2024} year` : `${currentYear - 2024} years`} of experience in. I utilize it mainly for various websites that require various data types to be processed in relatively complex manners where Javascript alone is not enough. </p>
          </div>
        </div>
