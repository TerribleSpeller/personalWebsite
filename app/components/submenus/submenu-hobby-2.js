...
export default function Submenu2() {
  ...
  return (
    <>
      ...
      <div id="React" className={`tabcontent-submenu ${activeTab === 'React' ? 'show' : ''} bg-light`}>
        <h3>React.js</h3>
      ...
      <div id="Next" className={`tabcontent-submenu ${activeTab === 'Next' ? 'show' : ''} bg-light`}>
        <h3>Next.js</h3>
      ...
      <div id="Bootstrap" className={`tabcontent-submenu ${activeTab === 'Bootstrap' ? 'show' : ''} bg-light`}>
        <h3>Bootstrap</h3>
