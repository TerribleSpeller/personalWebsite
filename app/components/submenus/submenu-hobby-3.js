  ...
  return (
    <>
      <div className="tab-submenu">
        ...
        <button className={`tablinks-submenu rounded-4 ${activeTab === 'React Native' ? 'active' : ''} `} onClick={() => openSubTab('React Native')}><span className="highLight">React Native</span></button>

      </div>

      <div id="Android Studio" className={`tabcontent-submenu ${activeTab === 'Android Studio' ? 'show' : ''} bg-light`}>
      ...
      <div id="React Native" className={`tabcontent-submenu ${activeTab === 'React Native' ? 'show' : ''} bg-light`}>
        <h3>React Native</h3>
